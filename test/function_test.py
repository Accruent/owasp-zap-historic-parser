...
class TestFunctions(unittest.TestCase):
    ...
    def test_convert_alert_to_dictionary_one_tuple(self):
        ...
        expected_dictionary = (
            "{'Test Level | Test Alert': {'Alert Level': 'Test Level', "
    ...
    def test_convert_alert_to_dictionary_multi_tuple(self):
        ...
        expected_dictionary = (
            "{'Test Level | Test Alert A': {'Alert Level': 'Test Level', "
    ...
    def test_html_parser(self):
        ...
        expected_result = (
            "[['Medium', 'X-Frame-Options Header Not Set', 1], ['Low', 'Cookie "
    ...
    def test_compare_zap_results_new(self):
        """This test verifies that compare zap results returns the alert table correctly."""
        this_dict = {
            "False Positive | New Alert": {
                "Alert Level": "False Positive",
                "Alert Type": "New Alert",
                "URLs Affected": 2,
            },
            "Informational | First Alert": {
    ...
    def test_get_alert_table_row_same(self):
        ...
        exp_result = (
            "<tr style='background-color: silver; color: white'><td style='border: "
    ...
    def test_get_alert_table_row_higher(self):
        """This test verifies that get alert table row returns the row correctly."""
        exp_result = (
            "<tr style='background-color: red; color: black'><td style='border: "
            "1px solid #000;'><strong>Test</strong></td><td style='border: 1px solid "
            "#000;'><strong>Test Type</strong></td><td style=' border: 1px solid #000;'>"
    ...
    def test_get_alert_table_row_lower(self):
        """This test verifies that get alert table row returns the row correctly."""
        exp_result = (
            "<tr style='background-color: yellow; color: white'><td style='border: "
            "1px solid #000;'><strong>Test</strong></td><td style='border: 1px solid "
            "#000;'><strong>Test Type</strong></td><td style=' border: 1px solid #000;'>"
    ...
    def test_get_alert_table_row_new(self):
        """This test verifies that get alert table row returns the row correctly."""
        exp_result = (
            "<tr style='background-color: gray; color: black'><td style='border: 1px "
    ...
    def test_get_alert_table_row_resolved(self):
        """This test verifies that get alert table row returns the row correctly."""
        exp_result = (
            "<tr style='background-color: black; color: white'><td style='border: 1px "
    ...
    def test_get_locators_new_locator(self):
        ...
        alert_result, url_count = get_locators(
            "//table[@class='alerts']//td[.='High']", 3
        )
